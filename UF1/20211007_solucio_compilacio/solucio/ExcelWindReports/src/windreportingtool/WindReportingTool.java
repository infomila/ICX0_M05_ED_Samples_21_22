...
public class WindReportingTool {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        ReportXLSX.writeReport(infos, fileNameOutput);
    ...
    public static class InfoWind {
        ...
        public InfoWind(String mNom, String mVelocity) {
            this.mNom = mNom;
    ...
    private static ArrayList<InfoWind> ferConsulta(ArrayList<String> beachCodes){
        ...
        try {
            ...
            List<Future<String>> resultats = exs.invokeAll(consultes);
            exs.shutdown();

            if(exs.awaitTermination(4, TimeUnit.MINUTES)){

                for(int i=0;i<resultats.size();i++) {
                    String vent = resultats.get(i).get();
